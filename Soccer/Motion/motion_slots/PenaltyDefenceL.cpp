// This is motion 'PenaltyDefenceL' translated from json file 
...
// page 0
  ...
  sfPoseGroup( MASK_RIGHT_HIP_SIDE, 1843, frameCount );
  ...
  sfPoseGroup( MASK_LEFT_HIP_SIDE, -1489, frameCount );
  ...
  sfPoseGroup( MASK_LEFT_SHOULDER, -107, frameCount );
...
// page 2
  ...
  sfPoseGroup( MASK_LEFT_ELBOW, 0, frameCount );
  sfPoseGroup( MASK_LEFT_ELBOW_SIDE, 0, frameCount );
  sfPoseGroup( MASK_LEFT_SHOULDER, -998, frameCount );
  sfPoseGroup( MASK_LEFT_CLAVICLE, 2104, frameCount );
  sfWaitFrame( frameCount );
// page 3
  frameCount = 50;
  sfPoseGroup( MASK_RIGHT_FOOT_SIDE, 1536, frameCount );
