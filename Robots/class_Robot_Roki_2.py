...
class Robot:
   ...
   #    (Servo ID, Bus number,  FACTOR,  FACTOR,     Limit,   Limit) 
            (10,        1,          1,     -1,        -711,    711),               # Прав Стопа Вбок
            (9,         1,         -1,      1,       -1333,    2310),              # Прав Стопа Вперед/Назад
            (8,         1,         -1,     -1,       -5333,    237),               # Прав Колено
            (7,         1,         -1,     -1,       -3851,    1481),              # Прав Бедро Вперед/Назад
            (6,         1,         -1,      1,       -3199,    444),               # Прав Бедро Вбок
            (5,         1,         -1,      1,       -2666,    2666),              # Прав Таз Вращение
            (4,         1,         -1,      1,       -711,     2666),              # Прав Локоть Вперед/Назад
            (3,         1,         -1,      1,       -3555,    5332),              # Прав Локоть Вращение
            (2,         1,         -1,      1,       -5036,    680),               # Прав Плечо Вбок
            (1,         1,         -1,      1,       -5925,    3555),              # Прав Ключица 
            (0,         2,          1,      1,       -2666,    2666),              # Торс
            (10,        2,          1,     -1,       -711,     711),              # Лев Стопа Вбок
            (9,         2,         -1,     -1,       -2310,    1333),              # Лев Стопа Вперед/Назад
            (8,         2,         -1,      1,       -237,     5333),              # Лев Колено
            (7,         2,         -1,     -1,       -1481,    3851),              # Лев Бедро Вперед/Назад
            (6,         2,         -1,      1,       -444,     3199),              # Лев Бедро Вбок
            (5,         2,         -1,      1,       -2666,    2666),              # Лев Таз Вращение
            (4,         2,         -1,      1,       -2666,    711),               # Лев Локоть Вперед/Назад
            (3,         2,         -1,      1,       -5332,    3555),              # Лев Локоть Вращение
            (2,         2,         -1,      1,       -680,     5036),              # Лев Плечо Вбок
            (1,         2,         -1,      1,       -3555,    5925),              # Лев Ключица
            (0,         1,         -1,      1,       -2666,    2666),              # Шея Вращение
            (12,        2,          1,      1,       -2600,    950),               # Шея Наклон
            (11,        1,          1,      1,       -2667,    5333),              # Прав Кисть
            (11,        2,          1,      1,       -2667,    5333),               # Лев Кисть
            (14,        1,          1,      1,           0,    2281),              # Прав Кисть
            (14,        2,          1,      1,           0,    2281)               # Лев Кисть
            ]
