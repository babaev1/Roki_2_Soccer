...
void page_2() {
	frameCount = 30; //12;
  	frameCount *= factor;
  	sfPoseGroup(MASK_FOOT_FRONT, 3400, frameCount);
...
void page_3(int i) {     
	...
	//sfPoseGroupLin(MASK_CLAVICLE, 2304 + i, frameCount);
  	sfPoseGroupLin(MASK_CLAVICLE, 3500 + i, frameCount);
...
void page_4(int i) {
	...
	sfPoseGroupLin(MASK_CLAVICLE, 3500 + i, frameCount);
  	//sfPoseGroupLin(MASK_CLAVICLE, 2840 + i, frameCount);
  	sfPoseGroup(MASK_HEAD_TILT, -921 + i, frameCount);
	sfWaitFrame(frameCount);
}
void page_5(int i) {
...
void page_6(int i) {
	...
	sfPoseGroupLin(MASK_CLAVICLE, -4000 + i, frameCount);
  	sfPoseGroup(MASK_HEAD_TILT, 4000, frameCount);
	sfWaitFrame(frameCount);
}
